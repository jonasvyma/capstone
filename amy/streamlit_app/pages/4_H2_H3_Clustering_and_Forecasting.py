...
@st.cache_data
def load_pokemon():
    df = pd.read_csv("C:/Users/amyby/Desktop/Bootcamp/final_project/data/final_dataset_csv.csv")
...
@st.cache_data
def load_starwars():
    sw = pd.read_csv("C:/Users/amyby/Desktop/Bootcamp/final_project/data/starwars_moc_loose_v7.csv")
