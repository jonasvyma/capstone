...
@st.cache_data
def load_data():
    df = pd.read_csv('C:/Users/amyby/Desktop/Bootcamp/final_project/data/starwars_filtered.csv')
    return df
...
try:
    ...
    st.error("Error: Could not find '../other files/starwars_filtered.csv'. Please ensure the data file exists.")
    st.stop()
